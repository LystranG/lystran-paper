...
这里是 **Lystran** 的个人博客仓库。
这是一个基于 **Astro** 构建的静态站点，旨在记录我的技术成长轨迹、代码逻辑以及对生活的思考。
...
| 维度 | 技术选型 | 说明 |
| :--- | :--- | :--- |
| **Framework** | [Astro](https://astro.build/) | 极快的静态站点生成器，岛屿架构 |
...
本仓库包含 **代码** 和 **内容** 两部分，采用不同的协议：

1.  **代码 (Source Code)**：
    基于 [MIT License](./LICENSE) 开源。你可以自由地学习、修改或使用本站的代码结构，但建议替换掉我的个人配置和文章内容。

2.  **内容 (Articles & Assets)**：
    若未特别指明，博客内的所有文章、图片及个人思考，均采用 **[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh)** 协议。
    *   ✅ **允许**：转载、分享、演绎。
    *   ❌ **禁止**：商业用途。
